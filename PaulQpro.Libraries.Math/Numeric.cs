...
namespace PaulQpro.Math.Numeric
{
    /// <summary>
    ...
    public sealed class UBin8
    {
        ...
        /// <summary>
        /// UBin8.MaxValue = 255 or { true, true, true, true, true, true, true, true }
        /// </summary>
        ...
        static public implicit operator UBin8(UBin4 value)
        {
            return (UBin8)(bool[])value;
        }
        /// <summary>
    ...
    public sealed class UBin4
    {
        private bool[] Value { get; set; }
        /// <summary>
        /// UBin4.MaxValue = 15 or { true, true, true, true }
        /// </summary>
        public static UBin4 MaxValue { get { UBin4 bin = new(); bin.Value = new bool[4] { true, true, true, true }; return bin; } }
        ...
        static public implicit operator UBin4(UBin8 value)
        {
            return (UBin4)(bool[])value;
        }
        /// <summary>
        /// Represents a string value of object : "b----"
        /// </summary>
    ...
    ///<summary>
    ///Represents Hexadecimal digit
    ///</summary>
    /*public sealed class HexDigit
    {
        private UBin4 Value { get; set; }
        static public implicit operator byte(HexDigit digit)
        {
            return digit.Value;
        }
        public HexDigit(UBin4 digit)
        {
            Value = digit;
        }
        private HexDigit() { Value = 0; }
    }*/
}